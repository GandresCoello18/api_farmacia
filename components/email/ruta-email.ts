    ...
    crearHash(req: Request, res: Response){
        ...
        Store.validar_id_user_existente(id_user)
            .then( data => {
                ...
                if(data != 0){
                    Store.borrar_hash(id_user).then( () => console.log('Hash existente eliminado') )
                }
                ...
                Store.crear_hash(obj)
                    .then( data => {
                        ...
                        Respuestas.error(req, res, err, 500, 'Error al crear el hash para la verificacion de email');
                    });
    ...
    borrarHash(req: Request, res: Response){
        ...
        Store.borrar_hash(id_user)
            .then( data => {
                ...
                Respuestas.error(req, res, err, 500, 'Error al eliminar el hash para la verificacion de email');
            });
    }
        ...
        Store.verificar_hash(hash)
            .then( (data: any) => {
                ...
                if(data != 0){
                    ...
                    Store.borrar_hash(data[0].id_user)
                        .then( () => console.log('Se elimino el hash'))

                    Respuestas.success(req, res, 'Email verificado exitosamente', 200);
                }else{
                    Respuestas.success(req, res, 'Ocurrio un error al verificar el email o ya fue verificado', 200);
                }
